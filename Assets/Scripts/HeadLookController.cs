...
public class HeadLookController : MonoBehaviour
{
    ...
    public class BendingSegment
    {
        ...
        public float thresholdAngleDifference = 0f;
    ...
    private void Start()
    {
        ...
        foreach (BendingSegment segment in segments)
        {
            ...
            segment.referenceLookDir = parentRotInv * rootNode.rotation * headLookVector.normalized;
            segment.referenceUpDir = parentRotInv * rootNode.rotation * headUpVector.normalized;
    ...
    private void LateUpdate()
    {
        ...
        foreach (BendingSegment segment in segments)
        {
            ...
            float hAngleThr = Mathf.Max(0f, Mathf.Abs(hAngle) - segment.thresholdAngleDifference) * Mathf.Sign(hAngle);
            float vAngleThr = Mathf.Max(0f, Mathf.Abs(vAngle) - segment.thresholdAngleDifference) * Mathf.Sign(vAngle);
